...
const timeline = [
  ...
  },
  {
    id: 3,
    text: '10:00',
    time: 'Start Olympic Distance Men 20, Men 30',
  ...
  },
  {
    id: 4,
    text: '10:05',
    time: 'Start Olympic Distance Men 40, Men 50, Men 60, Men 70+',
    icon: RocketLaunchIcon,
    iconBackground: 'bg-rose-400',
  },
  {
    id: 5,
    text: '10:10',
    time: 'Start Olympic Distance Women 20, Women 30, Women 40, Women 50, Women 60',
    icon: RocketLaunchIcon,
    iconBackground: 'bg-rose-400',
  },
  {
    id: 6,
    text: '10:15',
    time: 'Start Dreiseenstafette alle Teams',
    icon: RocketLaunchIcon,
    iconBackground: 'bg-rose-400',
  },
  {
    id: 7,
    text: '10:20',
    time: 'Start Short Distance Club Meisterschaft ASC Konstanz',
    icon: RocketLaunchIcon,
    iconBackground: 'bg-rose-400',
  },
  {
    id: 8,
    text: '10:25',
    time: 'Start Short Distance Men U20, Men 20, Men 30',
    icon: RocketLaunchIcon,
    iconBackground: 'bg-rose-400',
  },
  {
    id: 9,
    text: '10:30',
    time: 'Start Short Distance Men Men 40, Men 50, Men 60, Men 70+',
    icon: RocketLaunchIcon,
    iconBackground: 'bg-rose-400',
  },
  {
    id: 10,
    text: '10:35',
    time: 'Start Short Distance Women U20, Women 20, Women 30, Women 50, Women 60',
    icon: RocketLaunchIcon,
    iconBackground: 'bg-rose-400',
  },
