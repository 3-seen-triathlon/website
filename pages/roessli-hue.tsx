                ...
                >
                    <div className="mt-5 md:col-span-2 md:mt-0 width">
                        <div className="grid grid-cols-6 gap-6 mb-6">
                            ...
                            <div className="col-span-6 sm:col-span-3">
                                <label htmlFor="alter_roessli" className="block text-sm font-medium text-gray-700">
                                    Jahrgang
                                </label>
                                <input
                                    required
                        ...
                        <div className="grid grid-cols-6 gap-6 mb-6">
                            ...
                            <div className="col-span-6 sm:col-span-3">
                                <label htmlFor="alter_reiter" className="block text-sm font-medium text-gray-700">
                                    Jahrgang
                                </label>
                                <input
                                    required
